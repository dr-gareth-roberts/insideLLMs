...
from insideLLMs.agents.routing import (
    IntentClassifier,
    ModelPool,
    Route,
    RouteMatch,
...
def test_select_route_strategy_branches():
    ...
    with patch("insideLLMs.agents.routing.random.choice", return_value=base_matches[1]):
...
def test_router_retry_error_path_and_cache_expiry():
    ...
    with patch("insideLLMs.agents.routing.time.sleep", return_value=None):
