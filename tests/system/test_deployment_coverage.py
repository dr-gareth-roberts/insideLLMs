...
from insideLLMs.system.deployment import (
    FASTAPI_AVAILABLE,
    APIKeyAuth,
    AppConfig,
    BatchEndpoint,
...
class TestGenerateRequestSchema:
    ...
    def test_minimal_request(self):
        from insideLLMs.system.deployment import GenerateRequest
...
class TestGenerateResponseSchema:
    ...
    def test_minimal_response(self):
        from insideLLMs.system.deployment import GenerateResponse
...
class TestProbeRequestSchema:
    ...
    def test_minimal_probe_request(self):
        from insideLLMs.system.deployment import ProbeRequest
...
class TestProbeResponseSchema:
    ...
    def test_minimal_probe_response(self):
        from insideLLMs.system.deployment import ProbeResponse
...
class TestBatchRequestSchema:
    ...
    def test_minimal_batch_request(self):
        from insideLLMs.system.deployment import BatchRequest
...
class TestBatchResponseSchema:
    ...
    def test_batch_response(self):
        from insideLLMs.system.deployment import BatchResponse
...
class TestHealthResponseSchema:
    ...
    def test_healthy_response(self):
        from insideLLMs.system.deployment import HealthResponse
...
class TestErrorResponseSchema:
    ...
    def test_basic_error(self):
        from insideLLMs.system.deployment import ErrorResponse
...
class TestDeploymentAppRoutes:
    ...
    def _make_client(self, model=None, config=None):
        ...
        from insideLLMs.system.deployment import DeploymentApp
...
class TestDeploymentAppIntegration:
    ...
    def test_deployment_app_without_fastapi_raises(self):
        ...
        model = Mock(spec=["generate"])
        with patch("insideLLMs.system.deployment.FASTAPI_AVAILABLE", False):
