...
>>> from insideLLMs.system.distributed import MapReduceExecutor
...
class WorkerStatus(Enum):
    ...
    >>> from insideLLMs.system.distributed import WorkerStatus, LocalWorker
    ...
    >>> from insideLLMs.system.distributed import WorkerStatus
...
class TaskResult:
    ...
    >>> from insideLLMs.system.distributed import TaskResult
    >>> result = TaskResult(
    ...     task_id="task_001",
    ...     success=True,
...
class WorkerInfo:
    ...
    >>> from insideLLMs.system.distributed import WorkerInfo, WorkerStatus
    ...
    >>> from insideLLMs.system.distributed import WorkerInfo
    >>> info = WorkerInfo(
    ...     id="worker_0",
    ...     tasks_completed=95,
    ...     tasks_failed=5
...
class TaskExecutor(ABC):
    ...
    >>> from insideLLMs.system.distributed import TaskExecutor
    ...
    >>> from insideLLMs.system.distributed import TaskExecutor, LocalDistributedExecutor
...
class FunctionExecutor(TaskExecutor):
    ...
    >>> from insideLLMs.system.distributed import FunctionExecutor
    >>> def square(x):
    ...     return x ** 2
...
class WorkQueue:
    ...
    >>> from insideLLMs.system.distributed import WorkQueue, Task
    >>> q = WorkQueue()
    ...
    def __init__(self, maxsize: int = 0):
        ...
        Examples
        --------
        >>> from insideLLMs.system.distributed import WorkQueue
        >>> unbounded = WorkQueue()
...
class LocalDistributedExecutor:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.system.distributed import LocalDistributedExecutor, FunctionExecutor
        >>> executor = FunctionExecutor(lambda x: x * 2)
...
class ProcessPoolDistributedExecutor:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.system.distributed import ProcessPoolDistributedExecutor
        >>> def my_func(x):
        ...     return x * 2
