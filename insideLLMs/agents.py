...
Examples:
    Basic ReAct Agent with Calculator Tool:
        ...
        >>> from insideLLMs.agents import Tool, ReActAgent, create_calculator_tool
    ...
    Using the @tool Decorator:
        ...
        >>> from insideLLMs.agents import tool, ReActAgent
        >>> from insideLLMs import DummyModel
        >>>
    ...
    Chain-of-Thought Reasoning:
        ...
        >>> from insideLLMs.agents import ChainOfThoughtAgent
        >>> from insideLLMs import DummyModel
        >>>
        >>> model = DummyModel()
    ...
    Using AgentExecutor with Hooks:
        ...
        >>> from insideLLMs.agents import ReActAgent, AgentExecutor, create_calculator_tool
        >>> from insideLLMs import DummyModel
        >>>
...
class AgentStatus(Enum):
    ...
    Examples:
        Checking agent result status:
            ...
            >>> from insideLLMs.agents import ReActAgent, AgentStatus
            >>> from insideLLMs import DummyModel
            >>>
        ...
        Using status in conditional logic:
            ...
            >>> from insideLLMs.agents import AgentStatus
            >>>
...
class AgentConfig:
    ...
    Examples:
        Creating a default configuration:
            ...
            >>> from insideLLMs.agents import AgentConfig
            >>>
            >>> config = AgentConfig()
        ...
        Creating a custom configuration for debugging:
            ...
            >>> from insideLLMs.agents import AgentConfig, ReActAgent
            >>> from insideLLMs import DummyModel
            >>>
...
class ToolParameter:
    ...
    Examples:
        Creating a required string parameter:
            ...
            >>> from insideLLMs.agents import ToolParameter
            >>>
        ...
        Using parameters to define a Tool:
            ...
            >>> from insideLLMs.agents import Tool, ToolParameter
            >>>
...
class ToolResult:
    ...
    Examples:
        Creating a successful result:
            ...
            >>> from insideLLMs.agents import ToolResult
            >>>
            >>> result = ToolResult(
        ...
        Using with tool execution:
            ...
            >>> from insideLLMs.agents import Tool
            >>>
...
class AgentStep:
    ...
    Examples:
        Creating a thinking step:
            ...
            >>> from insideLLMs.agents import AgentStep
            >>>
            >>> step = AgentStep(
            ...     step_number=1,
        ...
        Creating a step with observation:
            ...
            >>> from insideLLMs.agents import AgentStep, ToolResult
            >>>
        ...
        Iterating through agent steps:
            ...
            >>> from insideLLMs.agents import ReActAgent, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
...
class AgentResult:
    ...
    Examples:
        ...
        Serializing result to JSON:
            ...
            >>> from insideLLMs.agents import ReActAgent
            >>> from insideLLMs import DummyModel
            >>>
            >>> agent = ReActAgent(DummyModel())
            >>> result = agent.run("Hello")
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples:
            >>> from insideLLMs.agents import AgentResult, AgentStatus
            >>>
...
class ToolRegistry:
    ...
    Examples:
        Creating a registry and registering tools:
            ...
            >>> from insideLLMs.agents import ToolRegistry, Tool
            >>>
        ...
        Registering functions directly:
            ...
            >>> from insideLLMs.agents import ToolRegistry
            >>>
            >>> registry = ToolRegistry()
            >>>
            >>> def multiply(x: int, y: int) -> int:
...
class AgentMemory:
    ...
    Examples:
        Creating memory and adding steps:
            ...
            >>> from insideLLMs.agents import AgentMemory, AgentStep
            >>>
        ...
        Using context storage:
            ...
            >>> from insideLLMs.agents import AgentMemory
            >>>
            >>> memory = AgentMemory()
        ...
        Formatting scratchpad for prompts:
            ...
            >>> from insideLLMs.agents import AgentMemory, AgentStep, AgentConfig
            >>>
            >>> memory = AgentMemory()
...
class BaseAgent(ABC):
    ...
    Examples:
        Creating a custom agent by subclassing:
            ...
            >>> from insideLLMs.agents import BaseAgent, AgentResult, AgentStatus
            >>> from abc import ABC
            >>>
        ...
        Using the tools property:
            ...
            >>> from insideLLMs.agents import ReActAgent, Tool
            >>> from insideLLMs import DummyModel
            >>>
            >>> def greet(name: str) -> str:
            ...     return f"Hello, {name}!"
...
class ReActAgent(BaseAgent):
    ...
    Examples:
        ...
        With custom configuration:
            ...
            >>> from insideLLMs.agents import ReActAgent, AgentConfig, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
            >>> config = AgentConfig(
            ...     max_iterations=5,
        ...
        With multiple tools:
            ...
            >>> from insideLLMs.agents import ReActAgent, Tool, create_calculator_tool, create_search_tool
            >>> from insideLLMs import DummyModel
            >>>
            >>> tools = [
...
class SimpleAgent(BaseAgent):
    ...
    Examples:
        Basic usage:
            ...
            >>> from insideLLMs.agents import SimpleAgent, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
        ...
        Without tools (direct answer):
            ...
            >>> from insideLLMs.agents import SimpleAgent
            >>> from insideLLMs import DummyModel
            >>>
        ...
        Handling tool errors:
            ...
            >>> from insideLLMs.agents import SimpleAgent, Tool, AgentStatus
            >>> from insideLLMs import DummyModel
            >>>
        ...
        Comparing with ReActAgent:
            ...
            >>> from insideLLMs.agents import SimpleAgent, ReActAgent
            >>> from insideLLMs import DummyModel
            >>>
...
class ChainOfThoughtAgent(BaseAgent):
    ...
    Examples:
        ...
        Comparing with other agents:
            ...
            >>> from insideLLMs.agents import ChainOfThoughtAgent, ReActAgent, SimpleAgent
            >>> from insideLLMs import DummyModel
            >>>
...
class AgentExecutor:
    ...
    Examples:
        Basic usage with hooks:
            ...
            >>> from insideLLMs.agents import ReActAgent, AgentExecutor
            >>> from insideLLMs import DummyModel
            >>>
            >>> def log_start(query, kwargs):
...
def create_calculator_tool() -> Tool:
    ...
    Examples:
        Basic usage:
            ...
            >>> from insideLLMs.agents import create_calculator_tool
            >>>
            >>> calc = create_calculator_tool()
            >>> print(calc.name)
            calculator
...
def create_search_tool(search_fn: Optional[Callable] = None) -> Tool:
    ...
    Examples:
        Basic usage with default (placeholder) function:
            ...
            >>> from insideLLMs.agents import create_search_tool
            >>>
        ...
        Using with an agent:
            ...
            >>> from insideLLMs.agents import ReActAgent, create_search_tool
            >>> from insideLLMs import DummyModel
            >>>
    ...
    *,
    ...
    Examples:
        ...
        Using with an agent:
            ...
            >>> from insideLLMs.agents import ReActAgent, create_python_tool
            >>> from insideLLMs import DummyModel
            >>>
...
def create_react_agent(
    ...
    Examples:
        Basic usage:
            ...
            >>> from insideLLMs.agents import create_react_agent
            >>> from insideLLMs import DummyModel
            >>>
        ...
        With tools:
            ...
            >>> from insideLLMs.agents import create_react_agent, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
            >>> calc = create_calculator_tool()
...
def create_simple_agent(
    ...
    Examples:
        Basic usage:
            ...
            >>> from insideLLMs.agents import create_simple_agent
            >>> from insideLLMs import DummyModel
            >>>
        ...
        With tools:
            ...
            >>> from insideLLMs.agents import create_simple_agent, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
...
def quick_agent_run(
    ...
    Examples:
        Quick ReAct agent run:
            ...
            >>> from insideLLMs.agents import quick_agent_run, create_calculator_tool
            >>> from insideLLMs import DummyModel
            >>>
        ...
        Using a simple agent:
            ...
            >>> from insideLLMs.agents import quick_agent_run
            >>> from insideLLMs import DummyModel
            >>>
            >>> result = quick_agent_run(
            ...     "Hello world",
