...
Example: Basic Token Importance Analysis
    >>> from insideLLMs.trace.introspection import estimate_token_importance
...
Example: Attention Pattern Analysis
    >>> from insideLLMs.trace.introspection import analyze_attention
...
Example: Full Model Introspection
    >>> from insideLLMs.trace.introspection import introspect_model
...
Example: Saliency Estimation
    >>> from insideLLMs.trace.introspection import estimate_saliency
