...
Examples:
    Basic template rendering:
        ...
        >>> from insideLLMs.prompts.templates import render_template
    ...
    Listing templates by category:
        ...
        >>> from insideLLMs.prompts.templates import list_templates, TemplateCategory
    ...
    Searching for templates:
        ...
        >>> from insideLLMs.prompts.templates import search_templates
    ...
    Creating and registering custom templates:
        ...
        >>> from insideLLMs.prompts.templates import (
...
class TemplateCategory(Enum):
    ...
    Examples:
        ...
        Using category in template info:
            ...
            >>> from insideLLMs.prompts.templates import PromptTemplateInfo, TemplateCategory
        ...
        Iterating over categories:
            ...
            >>> from insideLLMs.prompts.templates import TemplateCategory
        ...
        Checking if a template matches a category:
            ...
            >>> from insideLLMs.prompts.templates import get_template, TemplateCategory
    ...
    def render(self, **kwargs) -> str:
        ...
        Examples:
            Basic rendering with all variables:
                ...
                >>> from insideLLMs.prompts.templates import get_template
                >>> template = get_template("chain_of_thought")
...
class TemplateLibrary:
    ...
    Examples:
        Creating and using a template library:
            ...
            >>> from insideLLMs.prompts.templates import TemplateLibrary
        ...
        Listing templates by category:
            ...
            >>> from insideLLMs.prompts.templates import TemplateLibrary, TemplateCategory
            >>> library = TemplateLibrary()
    ...
    def __init__(self):
        ...
        Examples:
            ...
            Each instance has its own template registry:
                ...
                >>> from insideLLMs.prompts.templates import TemplateLibrary, PromptTemplateInfo, TemplateCategory
...
def list_templates(category: Optional[TemplateCategory] = None) -> list[PromptTemplateInfo]:
    ...
    Examples:
        Listing all templates:
            ...
            >>> from insideLLMs.prompts.templates import list_templates
...
def get_library() -> TemplateLibrary:
    ...
    Examples:
        Getting the library instance:
            ...
            >>> from insideLLMs.prompts.templates import get_library
            >>> library = get_library()
        ...
        Using list_names method (not exposed at module level):
            ...
            >>> from insideLLMs.prompts.templates import get_library, TemplateCategory
            >>> library = get_library()
        ...
        Verifying it is the same instance:
            ...
            >>> from insideLLMs.prompts.templates import get_library, register_template
            >>> from insideLLMs.prompts.templates import PromptTemplateInfo, TemplateCategory
            >>> library = get_library()
            >>> custom = PromptTemplateInfo(
