...
>>> from insideLLMs.diversity import analyze_diversity
...
>>> from insideLLMs.diversity import detect_repetition
...
>>> from insideLLMs.diversity import analyze_output_variability
>>> outputs = [
...
>>> from insideLLMs.diversity import analyze_creativity
...
>>> from insideLLMs.diversity import calculate_type_token_ratio
...
>>> from insideLLMs.diversity import LexicalDiversityAnalyzer, DiversityMetric
...
class DiversityMetric(Enum):
    ...
    >>> from insideLLMs.diversity import DiversityMetric, LexicalDiversityAnalyzer
    >>> analyzer = LexicalDiversityAnalyzer()
...
class CreativityDimension(Enum):
    ...
    >>> from insideLLMs.diversity import CreativityDimension, CreativityAnalyzer
...
class DiversityScore:
    ...
    >>> from insideLLMs.diversity import DiversityScore, DiversityMetric
    ...
    >>> from insideLLMs.diversity import LexicalDiversityAnalyzer
    >>> analyzer = LexicalDiversityAnalyzer()
...
class RepetitionAnalysis:
    ...
    >>> from insideLLMs.diversity import RepetitionDetector
...
class CreativityScore:
    ...
    >>> from insideLLMs.diversity import CreativityAnalyzer
    >>> analyzer = CreativityAnalyzer()
    ...
    >>> from insideLLMs.diversity import CreativityDimension
...
class VariabilityAnalysis:
    ...
    >>> from insideLLMs.diversity import OutputVariabilityAnalyzer
...
class DiversityReport:
    ...
    >>> from insideLLMs.diversity import DiversityReporter
    ...
    >>> from insideLLMs.diversity import DiversityMetric
