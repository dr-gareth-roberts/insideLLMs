...
>>> from insideLLMs.retrieval import Retriever, InMemoryVectorStore
...
>>> from insideLLMs.retrieval import TextChunker, ChunkingConfig
>>>
...
>>> from insideLLMs.retrieval import Document, Retriever
>>>
...
class Document:
    ...
    >>> from insideLLMs.retrieval import Retriever, InMemoryVectorStore, SimpleEmbedding
    >>> docs = [
    ...     Document(
...
class InMemoryVectorStore:
    ...
    >>> from insideLLMs.retrieval import Retriever, SimpleEmbedding
    >>> embedding = SimpleEmbedding()
    >>> store = InMemoryVectorStore()
    >>> retriever = Retriever(embedding, store)
...
class TextChunker:
    ...
    >>> from insideLLMs.retrieval import ChunkingConfig
    ...
    >>> from insideLLMs.retrieval import Document
...
class Retriever:
    ...
    >>> from insideLLMs.retrieval import Retriever, SimpleEmbedding, InMemoryVectorStore
    >>> embedding = SimpleEmbedding()
    >>> store = InMemoryVectorStore()
    >>> retriever = Retriever(embedding, store)
    >>>
...
class RAGChain:
    ...
    >>> from insideLLMs.retrieval import RAGChain
    >>> from insideLLMs.models import OpenAIModel
    >>>
    >>> model = OpenAIModel(model_name="gpt-4")
    >>> rag = RAGChain(model=model)
