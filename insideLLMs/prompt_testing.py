...
>>> from insideLLMs.prompt_testing import create_few_shot_variants
>>>
>>> examples = [
...     {"input": "2 + 2", "output": "4"},
...     {"input": "3 * 4", "output": "12"},
...
class PromptStrategy(Enum):
    ...
    >>> from insideLLMs.prompt_testing import PromptStrategy, PromptVariant
    >>>
...
class PromptVariant:
    ...
    >>> from insideLLMs.prompt_testing import PromptVariant
    >>>
    >>> variant = PromptVariant(
    ...     id="baseline",
    ...
    >>> from insideLLMs.prompt_testing import PromptVariant, PromptStrategy
    >>>
    >>> variant = PromptVariant(
    ...     id="expert_cot",
...
class PromptTestResult:
    ...
    >>> from insideLLMs.prompt_testing import PromptTestResult
    >>>
...
class PromptVariationGenerator:
    ...
    >>> from insideLLMs.prompt_testing import PromptVariationGenerator
    >>>
...
class ScoringCriteria:
    ...
    >>> from insideLLMs.prompt_testing import ScoringCriteria
    >>>
...
class PromptScorer:
    ...
    >>> from insideLLMs.prompt_testing import PromptScorer
    >>>
    >>> scorer = PromptScorer()
...
class PromptABTestRunner:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.prompt_testing import PromptABTestRunner, PromptScorer
        >>>
        >>> # With default scorer
...
class ExpandablePromptTemplate:
    ...
    >>> from insideLLMs.prompt_testing import ExpandablePromptTemplate
    >>>
...
class PromptExperiment:
    ...
    >>> from insideLLMs.prompt_testing import PromptExperiment
    >>>
    >>> # Create experiment
    ...
    def add_variant(
        ...
        >>> from insideLLMs.prompt_testing import PromptExperiment, PromptStrategy
        >>>
        >>> experiment = (
...
def create_cot_variants(
    ...
    >>> from insideLLMs.prompt_testing import create_cot_variants
    >>>
