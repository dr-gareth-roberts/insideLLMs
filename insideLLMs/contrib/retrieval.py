...
>>> from insideLLMs.contrib.retrieval import RAGChain, InMemoryVectorStore
...
>>> from insideLLMs.contrib.retrieval import Retriever, InMemoryVectorStore
...
>>> from insideLLMs.contrib.retrieval import TextChunker, ChunkingConfig
>>>
...
>>> from insideLLMs.contrib.retrieval import Document, Retriever
>>>
...
class Document:
    ...
    >>> from insideLLMs.contrib.retrieval import Retriever, InMemoryVectorStore, SimpleEmbedding
    >>> docs = [
    ...     Document(
...
class InMemoryVectorStore:
    ...
    >>> from insideLLMs.contrib.retrieval import Retriever, SimpleEmbedding
    >>> embedding = SimpleEmbedding()
    >>> store = InMemoryVectorStore()
    >>> retriever = Retriever(embedding, store)
...
class TextChunker:
    ...
    >>> from insideLLMs.contrib.retrieval import ChunkingConfig
    ...
    >>> from insideLLMs.contrib.retrieval import Document
...
class Retriever:
    ...
    >>> from insideLLMs.contrib.retrieval import Retriever, SimpleEmbedding, InMemoryVectorStore
    >>> embedding = SimpleEmbedding()
    >>> store = InMemoryVectorStore()
    >>> retriever = Retriever(embedding, store)
    >>>
...
class RAGChain:
    ...
    >>> from insideLLMs.contrib.retrieval import (
