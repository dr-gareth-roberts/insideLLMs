...
>>> from insideLLMs.contrib.preprocessing import TextNormalizer
...
>>> from insideLLMs.contrib.preprocessing import TextCleaner
...
>>> from insideLLMs.contrib.preprocessing import ProcessingPipeline, TextNormalizer, TextCleaner
...
>>> from insideLLMs.contrib.preprocessing import TextSplitter
...
>>> from insideLLMs.contrib.preprocessing import batch_texts
...
class NormalizationLevel(Enum):
    ...
    >>> from insideLLMs.contrib.preprocessing import NormalizationLevel
...
class TextStats:
    ...
    >>> from insideLLMs.contrib.preprocessing import TextStats
...
class ProcessingStep:
    ...
    >>> from insideLLMs.contrib.preprocessing import ProcessingStep
    >>> step = ProcessingStep(
    ...     name="lowercase",
    ...     func=str.lower,
    ...     enabled=True
...
class ProcessingPipeline:
    ...
    def __init__(self):
        ...
        >>> from insideLLMs.contrib.preprocessing import ProcessingPipeline
        >>> pipeline = ProcessingPipeline()
        >>> pipeline.list_steps()
        []
...
class DataValidator:
    ...
    >>> from insideLLMs.contrib.preprocessing import DataValidator
...
def normalize_whitespace(text: str) -> str:
    ...
    >>> from insideLLMs.contrib.preprocessing import normalize_whitespace
...
def normalize_unicode(text: str, form: str = "NFKC") -> str:
    ...
    >>> from insideLLMs.contrib.preprocessing import normalize_unicode
...
def remove_special_chars(text: str, keep: str = "") -> str:
    ...
    >>> from insideLLMs.contrib.preprocessing import remove_special_chars
...
def truncate_text(
    ...
    >>> from insideLLMs.contrib.preprocessing import truncate_text
...
def count_tokens_approx(text: str, chars_per_token: float = 4.0) -> int:
    ...
    >>> from insideLLMs.contrib.preprocessing import count_tokens_approx
...
def deduplicate_texts(
    ...
    >>> from insideLLMs.contrib.preprocessing import deduplicate_texts
...
def filter_by_length(
    ...
    >>> from insideLLMs.contrib.preprocessing import filter_by_length
...
def create_standard_pipeline() -> ProcessingPipeline:
    ...
    >>> from insideLLMs.contrib.preprocessing import create_standard_pipeline
...
def create_minimal_pipeline() -> ProcessingPipeline:
    ...
    >>> from insideLLMs.contrib.preprocessing import create_minimal_pipeline
