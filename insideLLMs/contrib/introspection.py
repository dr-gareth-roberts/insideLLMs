...
Example: Basic Token Importance Analysis
    >>> from insideLLMs.contrib.introspection import estimate_token_importance
...
Example: Attention Pattern Analysis
    >>> from insideLLMs.contrib.introspection import analyze_attention
...
Example: Full Model Introspection
    >>> from insideLLMs.contrib.introspection import introspect_model
...
Example: Saliency Estimation
    >>> from insideLLMs.contrib.introspection import estimate_saliency
