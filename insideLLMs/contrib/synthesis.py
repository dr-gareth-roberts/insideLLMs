...
Example 1: Quick Prompt Variations
    ...
    >>> from insideLLMs.contrib.synthesis import quick_variations
...
Example 3: Generating Adversarial Test Cases
    ...
    >>> from insideLLMs.contrib.synthesis import AdversarialGenerator, AdversarialType
    >>> from insideLLMs import DummyModel
    >>>
...
Example 4: Dataset Augmentation and Balancing
    ...
    >>> from insideLLMs.contrib.synthesis import DataAugmenter
    >>> from insideLLMs import DummyModel
    >>>
...
class VariationStrategy(Enum):
    ...
    Example 1: Using strategy enum values directly
        >>> from insideLLMs.contrib.synthesis import VariationStrategy
    ...
    Example 4: Using in PromptVariator
        >>> from insideLLMs.contrib.synthesis import PromptVariator, VariationStrategy
        >>> from insideLLMs import DummyModel
...
class AdversarialType(Enum):
    ...
    Example 1: Accessing attack type values
        >>> from insideLLMs.contrib.synthesis import AdversarialType
...
class SynthesisConfig:
    ...
    Example 1: Default configuration
        >>> from insideLLMs.contrib.synthesis import SynthesisConfig
...
class GeneratedVariation:
    ...
    Example 1: Creating a variation manually
        >>> from insideLLMs.contrib.synthesis import GeneratedVariation
    ...
    Example 4: Working with generated variations
        >>> from insideLLMs.contrib.synthesis import PromptVariator
        >>> from insideLLMs import DummyModel
        >>> variator = PromptVariator(model=DummyModel())
...
class AdversarialExample:
    ...
    Example 1: Creating an adversarial example manually
        >>> from insideLLMs.contrib.synthesis import AdversarialExample
    ...
    Example 3: Using generated adversarial examples
        >>> from insideLLMs.contrib.synthesis import AdversarialGenerator
        >>> from insideLLMs import DummyModel
        >>> generator = AdversarialGenerator(model=DummyModel())
...
class SyntheticDataset:
    ...
    Example 1: Creating and populating a dataset
        >>> from insideLLMs.contrib.synthesis import SyntheticDataset
...
class AdversarialGenerator:
    ...
    def __init__(
        ...
        Example 2: With custom config
            >>> from insideLLMs.contrib.synthesis import AdversarialGenerator, SynthesisConfig
            >>> from insideLLMs import DummyModel
...
class DataAugmenter:
    ...
    def __init__(
        ...
        Example 2: With custom config
            >>> from insideLLMs.contrib.synthesis import DataAugmenter, SynthesisConfig
            >>> from insideLLMs import DummyModel
...
class TemplateGenerator:
    ...
    Example 1: Template-based generation
        >>> from insideLLMs.contrib.synthesis import TemplateGenerator
...
def quick_adversarial(
    ...
    Example 1: Generate edge cases
        >>> from insideLLMs.contrib.synthesis import quick_adversarial
        >>> from insideLLMs import DummyModel
