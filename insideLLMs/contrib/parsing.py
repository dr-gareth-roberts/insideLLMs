...
>>> from insideLLMs.contrib.parsing import parse_json
>>> response = '''
...
>>> from insideLLMs.contrib.parsing import parse_code
>>> response = '''
...
>>> from insideLLMs.contrib.parsing import parse_list
>>> response = '''
...
>>> from insideLLMs.contrib.parsing import extract_answer
...
class OutputFormat(Enum):
    ...
    >>> from insideLLMs.contrib.parsing import detect_format, OutputFormat
    >>> text = '{"key": "value"}'
...
class CodeBlock:
    ...
    >>> from insideLLMs.contrib.parsing import CodeBlockParser
    >>> response = '''
    ... ```javascript
    ... console.log("Hello");
    ... ```
...
class TableData:
    ...
    >>> from insideLLMs.contrib.parsing import parse_table
    >>> response = '''
    ... | Language   | Year |
    ... |------------|------|
    ... | Python     | 1991 |
...
class JSONParser:
    ...
    >>> from insideLLMs.contrib.parsing import JSONParser
...
class ListParser:
    ...
    >>> from insideLLMs.contrib.parsing import ListParser
    >>> text = '''
    ... 1. First item
    ... 2. Second item
    ... 3. Third item
...
class TableParser:
    ...
    >>> from insideLLMs.contrib.parsing import TableParser
    >>> text = '''
    ... | Name    | Age |
    ... |---------|-----|
    ... | Alice   | 30  |
...
class AnswerExtractor:
    ...
    >>> from insideLLMs.contrib.parsing import AnswerExtractor
...
class OutputDetector:
    ...
    >>> from insideLLMs.contrib.parsing import OutputDetector, OutputFormat
