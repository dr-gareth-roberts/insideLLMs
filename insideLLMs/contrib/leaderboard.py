...
>>> from insideLLMs.contrib.leaderboard import ModelScore, create_leaderboard
>>> scores = [
...
>>> from insideLLMs.contrib.leaderboard import quick_leaderboard
>>> results = {
...
>>> from insideLLMs.contrib.leaderboard import format_leaderboard
...
>>> from insideLLMs.contrib.leaderboard import compare_leaderboards
...
class RankingMethod(Enum):
    ...
    >>> from insideLLMs.contrib.leaderboard import ModelRanker, RankingMethod
...
class ScoreAggregation(Enum):
    ...
    >>> from insideLLMs.contrib.leaderboard import ScoreAggregator, ScoreAggregation
...
class TrendDirection(Enum):
    ...
    >>> from insideLLMs.contrib.leaderboard import quick_leaderboard, TrendDirection
    ...
    >>> from insideLLMs.contrib.leaderboard import TrendDirection
    >>> improving_models = [
...
class ModelScore:
    ...
    >>> from insideLLMs.contrib.leaderboard import ModelScore
    >>> score = ModelScore(
    ...     model_id="gpt-4",
    ...     benchmark_id="mmlu",
    ...     score=0.89
...
class LeaderboardEntry:
    ...
    >>> from insideLLMs.contrib.leaderboard import LeaderboardEntry, TrendDirection
