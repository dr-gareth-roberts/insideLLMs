...
Example: Comprehensive robustness assessment
    >>> from insideLLMs.contrib.adversarial import assess_robustness, AttackType
    >>> def mock_model(text):
...
class AttackType(Enum):
    ...
    Example: Iterating over all attack types
        >>> from insideLLMs.contrib.adversarial import AttackType
...
class RobustnessLevel(Enum):
    ...
    Example: Interpreting robustness levels
        >>> from insideLLMs.contrib.adversarial import RobustnessLevel
...
class PerturbedText:
    ...
    Example: Creating a PerturbedText manually
        >>> from insideLLMs.contrib.adversarial import PerturbedText, AttackType
        >>> pt = PerturbedText(
        ...     original="hello",
...
class RobustnessReport:
    ...
    Example: Analyzing vulnerabilities
        >>> from insideLLMs.contrib.adversarial import assess_robustness
...
class VulnerabilityAssessment:
    ...
    Example: Creating a vulnerability assessment
        >>> from insideLLMs.contrib.adversarial import VulnerabilityAssessment, AttackType, PerturbedText
...
class TextPerturbator:
    ...
    def perturb_typo(self, text: str, num_typos: int = 1) -> PerturbedText:
        ...
        Example: Checking perturbation details
            >>> from insideLLMs.contrib.adversarial import TextPerturbator, AttackType
            >>> pert = TextPerturbator(seed=42)
            >>> result = pert.perturb_typo("hello")
...
class RobustnessTester:
    ...
    Example: Analyzing vulnerabilities
        >>> from insideLLMs.contrib.adversarial import RobustnessTester
        >>> tester = RobustnessTester(seed=42)
...
class InputManipulationDetector:
    ...
    Example: Detecting homoglyphs
        >>> from insideLLMs.contrib.adversarial import InputManipulationDetector
