...
>>> from insideLLMs.contrib.prompt_utils import PromptBuilder
...
>>> from insideLLMs.contrib.prompt_utils import create_few_shot_prompt
>>> examples = [
...
>>> from insideLLMs.contrib.prompt_utils import PromptLibrary
...
>>> from insideLLMs.contrib.prompt_utils import PromptComposer
...
>>> from insideLLMs.contrib.prompt_utils import PromptValidator
...
class PromptRole(Enum):
    ...
    >>> from insideLLMs.contrib.prompt_utils import PromptRole, PromptMessage
...
class PromptMessage:
    ...
    >>> from insideLLMs.contrib.prompt_utils import PromptMessage, PromptRole
...
class PromptVersion:
    ...
    >>> from insideLLMs.contrib.prompt_utils import PromptVersion
    >>> pv = PromptVersion(
