...
>>> from insideLLMs.contrib.prompt_testing import (
...
>>> from insideLLMs.contrib.prompt_testing import create_few_shot_variants
>>>
>>> examples = [
...     {"input": "2 + 2", "output": "4"},
...     {"input": "3 * 4", "output": "12"},
...
class PromptStrategy(Enum):
    ...
    >>> from insideLLMs.contrib.prompt_testing import PromptStrategy, PromptVariant
    >>>
...
class PromptVariant:
    ...
    >>> from insideLLMs.contrib.prompt_testing import PromptVariant, PromptStrategy
    >>>
    >>> variant = PromptVariant(
    ...     id="expert_cot",
...
class PromptTestResult:
    ...
    >>> from insideLLMs.contrib.prompt_testing import PromptTestResult
    >>>
...
class PromptVariationGenerator:
    ...
    >>> from insideLLMs.contrib.prompt_testing import PromptVariationGenerator
    >>>
...
class ScoringCriteria:
    ...
    >>> from insideLLMs.contrib.prompt_testing import ScoringCriteria
    >>>
...
class PromptScorer:
    ...
    >>> from insideLLMs.contrib.prompt_testing import PromptScorer
    >>>
    >>> scorer = PromptScorer()
...
class PromptABTestRunner:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.contrib.prompt_testing import PromptABTestRunner, PromptScorer
        >>>
        >>> # With default scorer
...
class ExpandablePromptTemplate:
    ...
    >>> from insideLLMs.contrib.prompt_testing import ExpandablePromptTemplate
    >>>
...
class PromptExperiment:
    ...
    def add_variant(
        ...
        >>> from insideLLMs.contrib.prompt_testing import PromptExperiment, PromptStrategy
        >>>
        >>> experiment = (
...
def create_cot_variants(
    ...
    >>> from insideLLMs.contrib.prompt_testing import create_cot_variants
    >>>
