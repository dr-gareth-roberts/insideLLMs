...
Basic deployment with default configuration:
    ...
    >>> from insideLLMs.contrib.deployment import create_app
...
Custom configuration with authentication and rate limiting:
    ...
    >>> from insideLLMs.contrib.deployment import create_app, DeploymentConfig, AppConfig
    >>> from insideLLMs import DummyModel
    >>>
    >>> config = AppConfig(
...
Adding probes to the deployment:
    ...
    >>> from insideLLMs.contrib.deployment import DeploymentApp, AppConfig
    >>> from insideLLMs import DummyModel
