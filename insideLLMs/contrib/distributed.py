...
class WorkerStatus(Enum):
    ...
    >>> from insideLLMs.contrib.distributed import WorkerStatus, LocalWorker
    ...
    >>> from insideLLMs.contrib.distributed import WorkerStatus
...
class WorkerInfo:
    ...
    >>> from insideLLMs.contrib.distributed import WorkerInfo, WorkerStatus
    ...
    >>> from insideLLMs.contrib.distributed import WorkerInfo
    >>> info = WorkerInfo(
    ...     id="worker_0",
    ...     tasks_completed=95,
    ...     tasks_failed=5
...
class TaskExecutor(ABC):
    ...
    >>> from insideLLMs.contrib.distributed import TaskExecutor
    ...
    >>> from insideLLMs.contrib.distributed import TaskExecutor, LocalDistributedExecutor
...
class WorkQueue:
    ...
    >>> from insideLLMs.contrib.distributed import WorkQueue, Task
    >>> q = WorkQueue()
...
class LocalDistributedExecutor:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.contrib.distributed import LocalDistributedExecutor, FunctionExecutor
        >>> executor = FunctionExecutor(lambda x: x * 2)
...
class ProcessPoolDistributedExecutor:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from insideLLMs.contrib.distributed import ProcessPoolDistributedExecutor
        >>> def my_func(x):
        ...     return x * 2
