...
Example: Basic HITL Session
    >>> from insideLLMs.contrib.hitl import HITLSession, CallbackInputHandler
...
Example: Approval Workflow with Confidence Threshold
    >>> from insideLLMs.contrib.hitl import ApprovalWorkflow
    >>>
...
Example: Priority Review Queue
    >>> from insideLLMs.contrib.hitl import PriorityReviewQueue, ReviewItem, Priority
    >>>
...
Example: Consensus Validation
    >>> from insideLLMs.contrib.hitl import ConsensusValidator
    >>>
...
class FeedbackType(str, Enum):
    ...
    Examples:
        Basic usage with Feedback:
            >>> from insideLLMs.contrib.hitl import FeedbackType, Feedback
            >>> feedback = Feedback(
...
class ReviewStatus(str, Enum):
    ...
    Examples:
        Creating a review item with status:
            >>> from insideLLMs.contrib.hitl import ReviewItem, ReviewStatus
            >>> item = ReviewItem(
...
class Priority(int, Enum):
    ...
    Examples:
        Setting priority on review items:
            >>> from insideLLMs.contrib.hitl import ReviewItem, Priority
...
class Feedback:
    ...
    Examples:
        Creating approval feedback:
            >>> from insideLLMs.contrib.hitl import Feedback, FeedbackType
            >>> feedback = Feedback(
            ...     feedback_type=FeedbackType.APPROVE,
...
class Annotation:
    ...
    Examples:
        Document-level annotation (sentiment labeling):
            >>> from insideLLMs.contrib.hitl import Annotation
...
class ReviewItem:
    ...
    Examples:
        Creating a review item:
            >>> from insideLLMs.contrib.hitl import ReviewItem, Priority, ReviewStatus
            >>> item = ReviewItem(
        ...
        Adding feedback to an item:
            >>> from insideLLMs.contrib.hitl import ReviewItem, Feedback, FeedbackType
            >>> item = ReviewItem(prompt="test", response="result")
        ...
        Adding annotations:
            >>> from insideLLMs.contrib.hitl import ReviewItem, Annotation
            >>> item = ReviewItem(
...
class HITLConfig:
    ...
    Examples:
        Default configuration:
            >>> from insideLLMs.contrib.hitl import HITLConfig
            >>> config = HITLConfig()
...
class ReviewQueue:
    ...
    Examples:
        Basic queue operations:
            >>> from insideLLMs.contrib.hitl import ReviewQueue, ReviewItem
            >>> queue = ReviewQueue()
...
class ConsoleInputHandler:
    ...
    Examples:
        ...
        Using with HITLSession:
            >>> from insideLLMs.contrib.hitl import HITLSession, ConsoleInputHandler
            >>> handler = ConsoleInputHandler()
            >>> session = HITLSession(model, input_handler=handler)
...
class ReviewWorkflow:
    ...
    Examples:
        Basic batch review workflow:
            >>> from insideLLMs.contrib.hitl import ReviewWorkflow, Priority
        ...
        Priority-based review:
            >>> from insideLLMs.contrib.hitl import ReviewWorkflow, PriorityReviewQueue, Priority
            >>> queue = PriorityReviewQueue()
...
class AnnotationWorkflow:
    ...
    Examples:
        Sentiment annotation:
            >>> from insideLLMs.contrib.hitl import AnnotationWorkflow
