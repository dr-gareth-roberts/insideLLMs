...
>>> from insideLLMs.contrib.sensitivity import quick_sensitivity_check
...
>>> from insideLLMs.contrib.sensitivity import analyze_prompt_sensitivity
...
>>> from insideLLMs.contrib.sensitivity import generate_perturbations, PerturbationType
...
>>> from insideLLMs.contrib.sensitivity import compare_prompt_sensitivity
>>> prompts = [
...
>>> from insideLLMs.contrib.sensitivity import check_format_sensitivity
...
class PerturbationType(Enum):
    ...
    >>> from insideLLMs.contrib.sensitivity import generate_perturbations
    >>> perturbations = generate_perturbations(
    ...     "Write code",
    ...     perturbation_types=[PerturbationType.TYPO, PerturbationType.CASE_CHANGE],
    ... )
...
class PromptPerturbator:
    ...
    >>> from insideLLMs.contrib.sensitivity import InputSensitivityAnalyzer
...
class InputSensitivityAnalyzer:
    ...
    >>> from insideLLMs.contrib.sensitivity import (
