...
>>> from insideLLMs.contrib.latency import LatencyTimer
>>> import time
>>> timer = LatencyTimer()
>>> with timer:
...
>>> from insideLLMs.contrib.latency import ResponseProfiler
...
>>> from insideLLMs.contrib.latency import PerformanceComparator, ResponseProfiler
...
>>> from insideLLMs.contrib.latency import quick_performance_check
...
>>> from insideLLMs.contrib.latency import measure_latency
...
class LatencyMetric(Enum):
    ...
    >>> from insideLLMs.contrib.latency import LatencyProfiler, LatencyMetric
...
class ThroughputMetric(Enum):
    ...
    >>> from insideLLMs.contrib.latency import ThroughputProfiler, ThroughputMetric
    ...
    >>> from insideLLMs.contrib.latency import calculate_throughput
    >>> tokens = 150
    >>> time_ms = 2000.0
...
class PerformanceLevel(Enum):
    ...
    >>> from insideLLMs.contrib.latency import PerformanceLevel
...
class LatencyMeasurement:
    ...
    >>> from insideLLMs.contrib.latency import LatencyMeasurement, LatencyMetric
...
class ThroughputMeasurement:
    ...
    >>> from insideLLMs.contrib.latency import ThroughputMeasurement, ThroughputMetric
...
class ResponseProfile:
    ...
    >>> from insideLLMs.contrib.latency import ResponseProfile
...
class PerformanceReport:
    ...
    >>> from insideLLMs.contrib.latency import PerformanceComparator
    >>> comparator = PerformanceComparator()
...
class LatencyProfiler:
    ...
    def __init__(self, model_id: Optional[str] = None):
        ...
        Examples
        --------
        >>> from insideLLMs.contrib.latency import LatencyProfiler
...
class ThroughputProfiler:
    ...
    def __init__(self, model_id: Optional[str] = None):
        ...
        Examples
        --------
        >>> from insideLLMs.contrib.latency import ThroughputProfiler
