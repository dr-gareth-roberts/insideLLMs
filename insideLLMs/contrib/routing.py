...
Example - Basic Routing:
    >>> from insideLLMs.contrib.routing import SemanticRouter, Route
...
Example - Cost-Optimized Routing:
    >>> from insideLLMs.contrib.routing import SemanticRouter, Route, RouterConfig, RoutingStrategy
    >>> from insideLLMs import DummyModel
    >>>
...
Example - Load Balanced Model Pool:
    >>> from insideLLMs.contrib.routing import ModelPool, RoutingStrategy
    >>> from insideLLMs import DummyModel
    >>>
...
Example - Intent-Based Routing:
    >>> from insideLLMs.contrib.routing import IntentClassifier, create_intent_router
    >>> from insideLLMs import DummyModel
    >>>
...
class RoutingStrategy(Enum):
    ...
    Example - Using BEST_MATCH strategy:
        >>> from insideLLMs.contrib.routing import RouterConfig, RoutingStrategy
...
class RouteStatus(Enum):
    ...
    Example - Checking route status:
        >>> from insideLLMs.contrib.routing import Route, RouteStatus
        >>> from insideLLMs import DummyModel
...
class RouterConfig:
    ...
    Example - Default configuration:
        >>> from insideLLMs.contrib.routing import RouterConfig
        >>> config = RouterConfig()
...
class RouteMatch:
    ...
    Example - Converting to dictionary for logging:
        >>> from insideLLMs.contrib.routing import RouteMatch
        >>> from insideLLMs import DummyModel
        >>> match = RouteMatch(
        ...     route_name="test",
        ...     score=0.85,
...
class RoutingResult:
    ...
    Example - Monitoring retries:
        >>> from insideLLMs.contrib.routing import SemanticRouter, Route, RouterConfig
        >>> from insideLLMs import DummyModel
    ...
    Example - Error handling:
        >>> from insideLLMs.contrib.routing import SemanticRouter
        >>> router = SemanticRouter()
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Example:
            >>> from insideLLMs.contrib.routing import RoutingResult
...
class RouteStats:
    ...
    Example - Monitoring error rates:
        >>> from insideLLMs.contrib.routing import Route, RouteStats
        >>> from insideLLMs import DummyModel
    ...
    Example - Converting to dictionary for reporting:
        >>> from insideLLMs.contrib.routing import RouteStats
...
class Route:
    ...
    Example - Creating a simple route:
        >>> from insideLLMs.contrib.routing import Route
        >>> from insideLLMs import DummyModel
        >>> route = Route(
        ...     name="greeting",
...
class SemanticMatcher:
    ...
    Example - Using with embeddings:
        >>> from insideLLMs.contrib.routing import SemanticMatcher
...
class SemanticRouter:
    ...
    def select_route(self, matches: list[RouteMatch]) -> Optional[RouteMatch]:
        ...
        Example - Best match selection:
            >>> from insideLLMs.contrib.routing import SemanticRouter, Route, RouteMatch
            >>> from insideLLMs import DummyModel
        ...
        Example - Round robin selection:
            >>> from insideLLMs.contrib.routing import SemanticRouter, Route, RouterConfig, RoutingStrategy, RouteMatch
            >>> from insideLLMs import DummyModel
            >>> config = RouterConfig(strategy=RoutingStrategy.ROUND_ROBIN)
            >>> router = SemanticRouter(config=config)
            >>> matches = [
...
class ModelPool:
    ...
    Example - Basic round-robin pool:
        >>> from insideLLMs.contrib.routing import ModelPool
        >>> from insideLLMs import DummyModel
    ...
    Example - Using pool as a route model:
        >>> from insideLLMs.contrib.routing import ModelPool, SemanticRouter, Route
        >>> from insideLLMs import DummyModel
...
class IntentClassifier:
    ...
    Example - Pattern-based classification:
        >>> from insideLLMs.contrib.routing import IntentClassifier
        >>> classifier = IntentClassifier()
    ...
    Example - Using with router:
        >>> from insideLLMs.contrib.routing import IntentClassifier, SemanticRouter, Route
        >>> from insideLLMs import DummyModel
        >>> # Create classifier
        >>> classifier = IntentClassifier()
...
def create_router(
    ...
    Example - Basic router creation:
        >>> from insideLLMs.contrib.routing import create_router
        >>> from insideLLMs import DummyModel
...
def quick_route(
    ...
    Example - Simple quick routing:
        >>> from insideLLMs.contrib.routing import quick_route
        >>> from insideLLMs import DummyModel
        >>> result = quick_route(
...
def create_intent_router(
    ...
    Example - Basic intent router:
        >>> from insideLLMs.contrib.routing import create_intent_router
        >>> from insideLLMs import DummyModel
