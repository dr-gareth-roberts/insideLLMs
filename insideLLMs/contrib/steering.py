...
Basic prompt steering with a prefix instruction:
    ...
    >>> from insideLLMs.contrib.steering import PromptSteerer, SteeringMethod
...
Extracting a steering vector from contrast activations:
    ...
    >>> from insideLLMs.contrib.steering import SteeringVectorExtractor
...
Creating a contrast pair for experimentation:
    ...
    >>> from insideLLMs.contrib.steering import create_contrast_pair
...
Running a full steerability analysis:
    ...
    >>> from insideLLMs.contrib.steering import quick_steering_analysis
...
class SteeringMethod(Enum):
    ...
    Using a steering method with PromptSteerer:
        ...
        >>> from insideLLMs.contrib.steering import SteeringMethod, PromptSteerer
        >>> steerer = PromptSteerer()
...
class ActivationLayer(Enum):
    ...
    Selecting layers for activation recording:
        ...
        >>> from insideLLMs.contrib.steering import ActivationLayer
...
class RepresentationSpace(Enum):
    ...
    Selecting representation space for analysis:
        ...
        >>> from insideLLMs.contrib.steering import RepresentationSpace
...
class SteeringStrength(Enum):
    ...
    Selecting steering strength:
        ...
        >>> from insideLLMs.contrib.steering import SteeringStrength
...
class SteeringVector:
    ...
    Creating a steering vector manually:
        ...
        >>> from insideLLMs.contrib.steering import SteeringVector
...
class ActivationPattern:
    ...
    Creating an activation pattern:
        ...
        >>> from insideLLMs.contrib.steering import ActivationPattern
...
class SteeringExperiment:
    ...
    Creating an experiment result:
        ...
        >>> from insideLLMs.contrib.steering import SteeringExperiment, SteeringMethod
...
class ContrastPair:
    ...
    Creating a formality contrast pair:
        ...
        >>> from insideLLMs.contrib.steering import ContrastPair
        >>> pair = ContrastPair(
...
class SteeringReport:
    ...
    Creating a steering report:
        ...
        >>> from insideLLMs.contrib.steering import (
...
class PromptSteerer:
    ...
    Basic prefix steering:
        ...
        >>> from insideLLMs.contrib.steering import PromptSteerer
        >>> steerer = PromptSteerer()
...
class ActivationAnalyzer:
    ...
    Recording and comparing patterns:
        ...
        >>> from insideLLMs.contrib.steering import ActivationAnalyzer
...
class BehavioralShiftMeasurer:
    ...
    Measuring formality shift:
        ...
        >>> from insideLLMs.contrib.steering import BehavioralShiftMeasurer
...
class SteeringExperimenter:
    ...
    Running a single experiment:
        ...
        >>> from insideLLMs.contrib.steering import SteeringExperimenter, SteeringMethod
        >>> def mock_model(prompt):
...
class RepresentationAnalyzer:
    ...
    Storing and comparing representations:
        ...
        >>> from insideLLMs.contrib.steering import RepresentationAnalyzer
...
def extract_steering_vector(
    ...
    Examples
    --------
    >>> from insideLLMs.contrib.steering import extract_steering_vector
    >>> pos = [1.0, 0.0, 0.5]
    >>> neg = [0.0, 1.0, 0.5]
...
def apply_prompt_steering(
    ...
    Examples
    --------
    >>> from insideLLMs.contrib.steering import apply_prompt_steering, SteeringMethod
...
def measure_behavioral_shift(
    ...
    Examples
    --------
    >>> from insideLLMs.contrib.steering import measure_behavioral_shift
...
def analyze_activation_patterns(
    ...
    Examples
    --------
    >>> from insideLLMs.contrib.steering import ActivationPattern, analyze_activation_patterns
    >>> patterns = [
