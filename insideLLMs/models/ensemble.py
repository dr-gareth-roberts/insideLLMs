...
>>> from insideLLMs.models.ensemble import ModelEnsemble, AggregationMethod
>>> def model_a(prompt):
...
>>> from insideLLMs.models.ensemble import ModelOutput, aggregate_responses
>>> outputs = [
...
>>> from insideLLMs.models.ensemble import analyze_model_agreement, ModelOutput
>>> outputs = [
...
>>> from insideLLMs.models.ensemble import quick_ensemble_check
...
class AggregationMethod(Enum):
    ...
    >>> from insideLLMs.models.ensemble import AggregationMethod, ResponseAggregator, ModelOutput
    >>> outputs = [
...
class AgreementLevel(Enum):
    ...
    >>> from insideLLMs.models.ensemble import aggregate_responses, ModelOutput, AgreementLevel
    >>> outputs = [
...
class EnsembleStrategy(Enum):
    ...
    >>> from insideLLMs.models.ensemble import EnsembleStrategy
...
class ModelOutput:
    ...
    >>> from insideLLMs.models.ensemble import ModelOutput
    >>> output = ModelOutput(
    ...     model_id="gpt-4",
...
class AggregatedOutput:
    ...
    >>> from insideLLMs.models.ensemble import aggregate_responses, ModelOutput, AggregationMethod
    >>> outputs = [
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.models.ensemble import aggregate_responses, ModelOutput
        >>> outputs = [
...
class ModelComparison:
    ...
    >>> from insideLLMs.models.ensemble import ModelComparison, ModelOutput
...
class EnsembleReport:
    ...
    >>> from insideLLMs.models.ensemble import evaluate_ensemble, ModelOutput, AggregationMethod
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.models.ensemble import EnsembleReport, AggregationMethod
...
class ResponseNormalizer:
    ...
    >>> from insideLLMs.models.ensemble import ResponseNormalizer
...
class TextSimilarityCalculator:
    ...
    >>> from insideLLMs.models.ensemble import TextSimilarityCalculator
...
class ResponseAggregator:
    ...
    >>> from insideLLMs.models.ensemble import ResponseAggregator, ModelOutput, AggregationMethod
    >>> aggregator = ResponseAggregator()
    >>> outputs = [
...
class ModelAgreementAnalyzer:
    ...
    >>> from insideLLMs.models.ensemble import ModelAgreementAnalyzer, ModelOutput
    ...
    def __init__(
        ...
        >>> from insideLLMs.models.ensemble import TextSimilarityCalculator, ResponseNormalizer
...
class EnsembleEvaluator:
    ...
    >>> from insideLLMs.models.ensemble import EnsembleEvaluator, ModelOutput
    ...
    >>> from insideLLMs.models.ensemble import AggregationMethod
    ...
    >>> from insideLLMs.models.ensemble import ResponseAggregator, ModelAgreementAnalyzer
    ...
    def __init__(
        ...
        >>> from insideLLMs.models.ensemble import ResponseAggregator
...
def create_ensemble(
    ...
    >>> from insideLLMs.models.ensemble import create_ensemble
...
def evaluate_ensemble(
    ...
    >>> from insideLLMs.models.ensemble import evaluate_ensemble, ModelOutput
    >>> prompt_outputs = [
