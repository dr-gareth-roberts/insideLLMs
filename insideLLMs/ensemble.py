...
>>> from insideLLMs.ensemble import ModelEnsemble, AggregationMethod
>>> def model_a(prompt):
...
>>> from insideLLMs.ensemble import ModelOutput, aggregate_responses
>>> outputs = [
...
>>> from insideLLMs.ensemble import analyze_model_agreement, ModelOutput
>>> outputs = [
...
>>> from insideLLMs.ensemble import quick_ensemble_check
...
class AggregationMethod(Enum):
    ...
    >>> from insideLLMs.ensemble import AggregationMethod, ResponseAggregator, ModelOutput
    >>> outputs = [
...
class AgreementLevel(Enum):
    ...
    >>> from insideLLMs.ensemble import aggregate_responses, ModelOutput, AgreementLevel
    >>> outputs = [
...
class EnsembleStrategy(Enum):
    ...
    >>> from insideLLMs.ensemble import EnsembleStrategy
...
class ModelOutput:
    ...
    >>> from insideLLMs.ensemble import ModelOutput
    >>> output = ModelOutput(
    ...     model_id="gpt-4",
...
class AggregatedOutput:
    ...
    >>> from insideLLMs.ensemble import aggregate_responses, ModelOutput, AggregationMethod
    >>> outputs = [
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.ensemble import aggregate_responses, ModelOutput
        >>> outputs = [
...
class ModelComparison:
    ...
    >>> from insideLLMs.ensemble import ModelComparison, ModelOutput
...
class EnsembleReport:
    ...
    >>> from insideLLMs.ensemble import evaluate_ensemble, ModelOutput, AggregationMethod
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.ensemble import EnsembleReport, AggregationMethod
...
class ResponseNormalizer:
    ...
    >>> from insideLLMs.ensemble import ResponseNormalizer
...
class TextSimilarityCalculator:
    ...
    >>> from insideLLMs.ensemble import TextSimilarityCalculator
...
class ResponseAggregator:
    ...
    >>> from insideLLMs.ensemble import ResponseAggregator, ModelOutput, AggregationMethod
    >>> aggregator = ResponseAggregator()
    >>> outputs = [
...
class ModelAgreementAnalyzer:
    ...
    >>> from insideLLMs.ensemble import ModelAgreementAnalyzer, ModelOutput
    ...
    def __init__(
        ...
        >>> from insideLLMs.ensemble import TextSimilarityCalculator, ResponseNormalizer
...
class EnsembleEvaluator:
    ...
    >>> from insideLLMs.ensemble import EnsembleEvaluator, ModelOutput
    ...
    >>> from insideLLMs.ensemble import AggregationMethod
    ...
    >>> from insideLLMs.ensemble import ResponseAggregator, ModelAgreementAnalyzer
    ...
    def __init__(
        ...
        >>> from insideLLMs.ensemble import ResponseAggregator
...
def create_ensemble(
    ...
    >>> from insideLLMs.ensemble import create_ensemble
...
def evaluate_ensemble(
    ...
    >>> from insideLLMs.ensemble import evaluate_ensemble, ModelOutput
    >>> prompt_outputs = [
