...
def run_harness_to_dir(
    ...
    *,
    ...
    resolved_quiet = (not verbose) if quiet is None else quiet
    if verbose and resolved_quiet:
        raise ValueError("verbose=True and quiet=True are mutually exclusive.")
