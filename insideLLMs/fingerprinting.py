...
>>> from insideLLMs.fingerprinting import quick_capability_assessment
>>> responses = {
...     "logical_deduction": (
...
>>> from insideLLMs.fingerprinting import compare_fingerprints
...
>>> from insideLLMs.fingerprinting import SkillAssessor, SkillType
...
>>> from insideLLMs.fingerprinting import detect_limitations
>>> responses = [
...
class CapabilityCategory(Enum):
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import CapabilityCategory
...
class CapabilityLevel(Enum):
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import CapabilityLevel, _score_to_level
    ...
    >>> from insideLLMs.fingerprinting import CapabilityScore, SkillType, CapabilityCategory
...
class SkillType(Enum):
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import SkillType, SkillAssessor
    >>> skill = SkillType.LOGICAL_DEDUCTION
    >>> print(skill.value)
    logical_deduction
...
def _score_to_level(score: float) -> CapabilityLevel:
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import _score_to_level, CapabilityLevel
...
class LimitationType(Enum):
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import LimitationType
    >>> limitation = LimitationType.HALLUCINATION_PRONE
    >>> print(limitation.value)
    hallucination_prone

    >>> # Use in limitation reports
    >>> from insideLLMs.fingerprinting import LimitationReport
...
class CapabilityScore:
    ...
    >>> from insideLLMs.fingerprinting import SkillAssessor
    >>> assessor = SkillAssessor()
...
class LimitationReport:
    ...
    Examples
    --------
    >>> from insideLLMs.fingerprinting import LimitationReport, LimitationType
    >>> report = LimitationReport(
    ...
    >>> from insideLLMs.fingerprinting import LimitationDetector
...
class SkillProfile:
    ...
    >>> from insideLLMs.fingerprinting import CapabilityProfiler
...
class ModelFingerprint:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.fingerprinting import create_fingerprint, SkillType
...
class CapabilityProbe:
    ...
    >>> from insideLLMs.fingerprinting import ReasoningProbe
    ...
    def generate_test(self) -> tuple[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.fingerprinting import ReasoningProbe, SkillType
        >>> probe = ReasoningProbe(SkillType.LOGICAL_DEDUCTION)
        >>> prompt, expected = probe.generate_test()
        >>> print(type(prompt))
        <class 'str'>
