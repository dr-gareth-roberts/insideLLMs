...
Examples:
    ...
    >>> from insideLLMs.conversation.conversation import Conversation, ConversationAnalyzer
    >>> conv = Conversation()
    ...
    >>> from insideLLMs.conversation.conversation import analyze_messages
    >>> messages = [
    ...
    >>> from insideLLMs.conversation.conversation import TopicTracker
    ...
    >>> from insideLLMs.conversation.conversation import Conversation, EngagementAnalyzer
    >>> conv = Conversation([
...
class ConversationConsistencyChecker:
    ...
    Examples:
        ...
        >>> from insideLLMs.conversation.conversation import ConversationMessage, ConversationTurn
        >>> turns = [
        ...     ConversationTurn(1,
