...
Example: Basic perturbation testing
    >>> from insideLLMs.security.adversarial import perturb_text, AttackType
...
Example: Detecting input manipulation
    >>> from insideLLMs.security.adversarial import detect_manipulation
...
Example: Comprehensive robustness assessment
    >>> from insideLLMs.security.adversarial import assess_robustness, AttackType
    >>> def mock_model(text):
...
Example: Generating adversarial examples for testing
    >>> from insideLLMs.security.adversarial import generate_adversarial_examples
...
class AttackType(Enum):
    ...
    Example: Iterating over all attack types
        >>> from insideLLMs.security.adversarial import AttackType
...
class RobustnessLevel(Enum):
    ...
    Example: Interpreting robustness levels
        >>> from insideLLMs.security.adversarial import RobustnessLevel
...
class PerturbedText:
    ...
    Example: Creating a PerturbedText manually
        >>> from insideLLMs.security.adversarial import PerturbedText, AttackType
        >>> pt = PerturbedText(
        ...     original="hello",
...
class AdversarialAttackResult:
    ...
    Example: Examining attack results
        >>> from insideLLMs.security.adversarial import RobustnessTester, AttackType
        >>> def echo_model(text):
        ...     return text.upper()
...
class RobustnessReport:
    ...
    Example: Analyzing vulnerabilities
        >>> from insideLLMs.security.adversarial import assess_robustness
...
class VulnerabilityAssessment:
    ...
    Example: Creating a vulnerability assessment
        >>> from insideLLMs.security.adversarial import VulnerabilityAssessment, AttackType, PerturbedText
    ...
    Example: Using the vulnerability scanner
        >>> from insideLLMs.security.adversarial import scan_vulnerabilities
...
class TextPerturbator:
    ...
    Example: Basic typo perturbation
        >>> from insideLLMs.security.adversarial import TextPerturbator
    ...
    def perturb_typo(self, text: str, num_typos: int = 1) -> PerturbedText:
        ...
        Example: Checking perturbation details
            >>> from insideLLMs.security.adversarial import TextPerturbator, AttackType
            >>> pert = TextPerturbator(seed=42)
            >>> result = pert.perturb_typo("hello")
...
class RobustnessTester:
    ...
    Example: Analyzing vulnerabilities
        >>> from insideLLMs.security.adversarial import RobustnessTester
        >>> tester = RobustnessTester(seed=42)
...
class InputManipulationDetector:
    ...
    Example: Detecting homoglyphs
        >>> from insideLLMs.security.adversarial import InputManipulationDetector
...
class VulnerabilityScanner:
    ...
    Example: Basic vulnerability scan
        >>> from insideLLMs.security.adversarial import VulnerabilityScanner
