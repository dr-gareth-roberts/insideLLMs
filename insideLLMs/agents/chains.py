...
>>> from insideLLMs.agents.chains import create_chain
>>>
...
...     return "?" in str(data)
>>>
>>> from insideLLMs.agents.chains import TransformStep
...
>>> from insideLLMs.agents.chains import LLMStep, RouterStrategy
>>>
>>> routes = {
...
>>> from insideLLMs.agents.chains import WorkflowTemplate
>>>
...
class RouterStrategy(Enum):
    ...
    >>> from insideLLMs.agents.chains import RouterStep, RouterStrategy, TransformStep
    >>>
    >>> routes = {
...
class WorkflowTemplate:
    ...
    def classify_and_route(
        ...
        classifier_step = LLMStep(
            "classify",
            "Classify the following input into one of these categories: {categories}. Output only the category name.\nInput: {input}",
            model_fn,
        ...
        return (
            ChainBuilder(name, model_fn)
            .step("classify", classifier_step)
            .route(
                "router",
                cast("Mapping[str, ChainStep]", route_steps),
