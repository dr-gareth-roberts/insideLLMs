...
>>> from insideLLMs.sensitivity import quick_sensitivity_check
...
>>> from insideLLMs.sensitivity import generate_perturbations, PerturbationType
...
>>> from insideLLMs.sensitivity import compare_prompt_sensitivity
>>> prompts = [
...
>>> from insideLLMs.sensitivity import check_format_sensitivity
...
class PerturbationType(Enum):
    ...
    >>> from insideLLMs.sensitivity import generate_perturbations
    >>> perturbations = generate_perturbations(
    ...     "Write code",
    ...     perturbation_types=[PerturbationType.TYPO, PerturbationType.CASE_CHANGE],
    ... )
...
class PromptPerturbator:
    ...
    >>> from insideLLMs.sensitivity import InputSensitivityAnalyzer
