...
>>> from insideLLMs.leaderboard import ModelScore, create_leaderboard
>>> scores = [
...
>>> from insideLLMs.leaderboard import quick_leaderboard
>>> results = {
...
>>> from insideLLMs.leaderboard import format_leaderboard
...
>>> from insideLLMs.leaderboard import compare_leaderboards
...
class RankingMethod(Enum):
    ...
    >>> from insideLLMs.leaderboard import ModelRanker, RankingMethod
...
class ScoreAggregation(Enum):
    ...
    >>> from insideLLMs.leaderboard import ScoreAggregator, ScoreAggregation
...
class TrendDirection(Enum):
    ...
    >>> from insideLLMs.leaderboard import quick_leaderboard, TrendDirection
    ...
    >>> from insideLLMs.leaderboard import TrendDirection
    >>> improving_models = [
...
class ModelScore:
    ...
    >>> from insideLLMs.leaderboard import ModelScore
    >>> score = ModelScore(
    ...     model_id="gpt-4",
    ...     benchmark_id="mmlu",
    ...     score=0.89
...
class LeaderboardEntry:
    ...
    >>> from insideLLMs.leaderboard import LeaderboardEntry, TrendDirection
