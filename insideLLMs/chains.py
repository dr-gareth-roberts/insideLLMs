...
>>> from insideLLMs.chains import create_chain
>>>
...
...     return "?" in str(data)
>>>
>>> from insideLLMs.chains import TransformStep
...
>>> from insideLLMs.chains import LLMStep, RouterStrategy
>>>
>>> routes = {
...
>>> from insideLLMs.chains import WorkflowTemplate
>>>
...
class RouterStrategy(Enum):
    ...
    >>> from insideLLMs.chains import RouterStep, RouterStrategy, TransformStep
    >>>
    >>> routes = {
