...
>>> from insideLLMs.adapters import create_adapter
>>>
...
>>> from insideLLMs.adapters import AdapterFactory, Provider
>>>
...
>>> from insideLLMs.adapters import create_fallback_chain
>>>
...
>>> from insideLLMs.adapters import create_adapter_pool
>>>
...
>>> from insideLLMs.adapters import create_mock_adapter
>>>
...
>>> from insideLLMs.adapters import list_models, get_model_info, Provider
>>>
...
class Provider(Enum):
    ...
    >>> from insideLLMs.adapters import Provider
...
class AdapterStatus(Enum):
    ...
    >>> from insideLLMs.adapters import create_adapter, AdapterStatus
    >>> adapter = create_adapter("gpt-4o", api_key="sk-...")
    ...
    >>> from insideLLMs.adapters import AdapterStatus
    ...
    >>> from insideLLMs.adapters import AdapterPool, AdapterStatus
...
class ModelCapability(Enum):
    ...
    >>> from insideLLMs.adapters import get_model_info, ModelCapability
    >>> info = get_model_info("gpt-4o")
    ...
    >>> from insideLLMs.adapters import ModelRegistry, ModelCapability
    ...
    >>> from insideLLMs.adapters import list_models, ModelCapability
    >>> models = list_models()
    >>> streaming_chat = [
    ...     m for m in models
    ...
    >>> from insideLLMs.adapters import create_adapter, ModelCapability, get_model_info
...
class AdapterModelInfo:
    ...
    >>> from insideLLMs.adapters import AdapterModelInfo, Provider, ModelCapability
    ...
    >>> from insideLLMs.adapters import get_model_info
    >>> info = get_model_info("gpt-4o")
...
class AdapterConfig:
    ...
    >>> from insideLLMs.adapters import AdapterConfig, Provider
    ...
    >>> from insideLLMs.adapters import AdapterConfig, Provider, OpenAIAdapter
    >>> config = AdapterConfig(
    ...     model_id="gpt-4o",
    ...     provider=Provider.OPENAI,
    ...     api_key="sk-..."
...
class GenerationParams:
    ...
    >>> from insideLLMs.adapters import GenerationParams
    ...
    >>> from insideLLMs.adapters import GenerationParams, create_adapter
...
class GenerationResult:
    ...
    >>> from insideLLMs.adapters import create_adapter, get_model_info
    >>> adapter = create_adapter("gpt-4o", api_key="sk-...")
    ...
    >>> from insideLLMs.adapters import create_adapter, GenerationParams
    >>> adapter = create_adapter("gpt-4o", api_key="sk-...")
...
class BaseAdapter(ABC):
    ...
    >>> from insideLLMs.adapters import BaseAdapter, GenerationResult, GenerationParams
    ...
    def __init__(self, config: AdapterConfig):
        ...
        Examples
        --------
        >>> from insideLLMs.adapters import AdapterConfig, Provider, BaseAdapter
        >>> config = AdapterConfig(
        ...     model_id="test-model",
        ...
        >>> from insideLLMs.adapters import MockAdapter
    ...
    def provider(self) -> Provider:
        ...
        Examples
        --------
        >>> from insideLLMs.adapters import create_mock_adapter, Provider
        >>> adapter = create_mock_adapter()
        >>> print(adapter.provider)
        Provider.MOCK
    ...
    def status(self) -> AdapterStatus:
        ...
        Examples
        --------
        >>> from insideLLMs.adapters import create_mock_adapter, AdapterStatus
        >>> adapter = create_mock_adapter()
        >>> print(adapter.status)
        AdapterStatus.READY
    ...
    def generate(
        ...
        **kwargs
        ...
        >>> from insideLLMs.adapters import create_mock_adapter, GenerationParams
        >>> adapter = create_mock_adapter()
        >>> params = GenerationParams(temperature=0.5, max_tokens=100)
    ...
    def _record_request(self) -> None:
        ...
        >>> from insideLLMs.adapters import BaseAdapter, GenerationResult
...
class MockAdapter(BaseAdapter):
    ...
    def __init__(self, config: AdapterConfig):
        ...
        Examples
        --------
        >>> from insideLLMs.adapters import AdapterConfig, Provider, MockAdapter
