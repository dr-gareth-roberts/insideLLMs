...
Basic reasoning extraction:
    ...
    >>> from insideLLMs.reasoning import extract_reasoning
    >>> text = '''
...
Analyzing reasoning quality:
    ...
    >>> from insideLLMs.reasoning import extract_reasoning, analyze_reasoning
    >>> text = '''
    ... Given: x = 5 and y = 3
...
Evaluating Chain-of-Thought responses:
    ...
    >>> from insideLLMs.reasoning import evaluate_cot
...
Generating CoT prompts:
    ...
    >>> from insideLLMs.reasoning import generate_cot_prompt
...
Batch evaluation with reporting:
    ...
    >>> from insideLLMs.reasoning import CoTEvaluator
...
class ReasoningType(Enum):
    ...
    Identifying reasoning type in extracted chains:
        ...
        >>> from insideLLMs.reasoning import extract_reasoning, ReasoningType
    ...
    Using reasoning type for analysis filtering:
        ...
        >>> from insideLLMs.reasoning import ReasoningType
...
class ReasoningStepType(Enum):
    ...
    Identifying step types in a chain:
        ...
        >>> from insideLLMs.reasoning import extract_reasoning, ReasoningStepType
        >>> text = '''
...
class ReasoningQuality(Enum):
    ...
    Assessing reasoning quality:
        ...
        >>> from insideLLMs.reasoning import assess_reasoning_quality, ReasoningQuality
        >>> good_reasoning = '''
    ...
    Filtering by quality threshold:
        ...
        >>> from insideLLMs.reasoning import ReasoningQuality
    ...
    Comparing quality levels:
        ...
        >>> from insideLLMs.reasoning import assess_reasoning_quality
...
class ReasoningStep:
    ...
    Creating a basic reasoning step:
        ...
        >>> from insideLLMs.reasoning import ReasoningStep, ReasoningStepType
        >>> step = ReasoningStep(
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        JSON serialization:
            ...
            >>> import json
            >>> from insideLLMs.reasoning import ReasoningStep
...
class ReasoningExtractor:
    ...
    Basic extraction:
        ...
        >>> from insideLLMs.reasoning import ReasoningExtractor
...
class ReasoningAnalyzer:
    ...
    Basic chain analysis:
        ...
        >>> from insideLLMs.reasoning import ReasoningExtractor, ReasoningAnalyzer
        >>> extractor = ReasoningExtractor()
    ...
    def _score_step(self, step: ReasoningStep) -> float:
        ...
        Examples
        --------
            >>> from insideLLMs.reasoning import ReasoningStep, ReasoningAnalyzer
            >>> analyzer = ReasoningAnalyzer()
...
class CoTPromptGenerator:
    ...
    Generating prompts with different styles:
        ...
        >>> from insideLLMs.reasoning import CoTPromptGenerator
