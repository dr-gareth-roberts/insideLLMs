...
Example 1: Quick Prompt Variations
    ...
    >>> from insideLLMs.datasets.synthesis import quick_variations
...
Example 2: Advanced Prompt Variation with Multiple Strategies
    ...
    >>> from insideLLMs.datasets.synthesis import PromptVariator, SynthesisConfig
    >>> from insideLLMs import DummyModel
    >>>
...
Example 3: Generating Adversarial Test Cases
    ...
    >>> from insideLLMs.datasets.synthesis import AdversarialGenerator, AdversarialType
    >>> from insideLLMs import DummyModel
    >>>
...
Example 4: Dataset Augmentation and Balancing
    ...
    >>> from insideLLMs.datasets.synthesis import DataAugmenter
    >>> from insideLLMs import DummyModel
    >>>
...
class VariationStrategy(Enum):
    ...
    Example 1: Using strategy enum values directly
        >>> from insideLLMs.datasets.synthesis import VariationStrategy
    ...
    Example 4: Using in PromptVariator
        >>> from insideLLMs.datasets.synthesis import PromptVariator, VariationStrategy
        >>> from insideLLMs import DummyModel
...
class AdversarialType(Enum):
    ...
    Example 1: Accessing attack type values
        >>> from insideLLMs.datasets.synthesis import AdversarialType
...
class SynthesisConfig:
    ...
    Example 1: Default configuration
        >>> from insideLLMs.datasets.synthesis import SynthesisConfig
...
class GeneratedVariation:
    ...
    Example 1: Creating a variation manually
        >>> from insideLLMs.datasets.synthesis import GeneratedVariation
    ...
    Example 4: Working with generated variations
        >>> from insideLLMs.datasets.synthesis import PromptVariator
        >>> from insideLLMs import DummyModel
        >>> variator = PromptVariator(model=DummyModel())
...
class AdversarialExample:
    ...
    Example 1: Creating an adversarial example manually
        >>> from insideLLMs.datasets.synthesis import AdversarialExample
    ...
    Example 3: Using generated adversarial examples
        >>> from insideLLMs.datasets.synthesis import AdversarialGenerator
        >>> from insideLLMs import DummyModel
        >>> generator = AdversarialGenerator(model=DummyModel())
...
class SyntheticDataset:
    ...
    Example 1: Creating and populating a dataset
        >>> from insideLLMs.datasets.synthesis import SyntheticDataset
...
class PromptVariator:
    ...
    def batch_generate(
        ...
        results = {}
        for text in texts:
            results[text] = self.generate(text, strategies, num_variations)  # type: ignore[arg-type]
        return results
...
class AdversarialGenerator:
    ...
    def __init__(
        ...
        Example 2: With custom config
            >>> from insideLLMs.datasets.synthesis import AdversarialGenerator, SynthesisConfig
            >>> from insideLLMs import DummyModel
...
class DataAugmenter:
    ...
    def __init__(
        ...
        Example 2: With custom config
            >>> from insideLLMs.datasets.synthesis import DataAugmenter, SynthesisConfig
            >>> from insideLLMs import DummyModel
...
class TemplateGenerator:
    ...
    Example 1: Template-based generation
        >>> from insideLLMs.datasets.synthesis import TemplateGenerator
...
Return as a JSON array of strings."""
                ...
                try:
                    ...
                    for var in variations[:num_per_example]:
                        ...
                        new_example["synthetic"] = "true"  # type: ignore[assignment]
...
def quick_variations(
    ...
    results = variator.generate(text, strategies, num_variations)  # type: ignore[arg-type]
...
def quick_adversarial(
    ...
    Example 1: Generate edge cases
        >>> from insideLLMs.datasets.synthesis import quick_adversarial
        >>> from insideLLMs import DummyModel
