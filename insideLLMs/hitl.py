...
Example: Basic HITL Session
    >>> from insideLLMs.hitl import HITLSession, CallbackInputHandler
...
Example: Approval Workflow with Confidence Threshold
    >>> from insideLLMs.hitl import ApprovalWorkflow
    >>>
...
Example: Priority Review Queue
    >>> from insideLLMs.hitl import PriorityReviewQueue, ReviewItem, Priority
    >>>
...
Example: Consensus Validation
    >>> from insideLLMs.hitl import ConsensusValidator
    >>>
...
class FeedbackType(str, Enum):
    ...
    Examples:
        Basic usage with Feedback:
            >>> from insideLLMs.hitl import FeedbackType, Feedback
            >>> feedback = Feedback(
...
class ReviewStatus(str, Enum):
    ...
    Examples:
        Creating a review item with status:
            >>> from insideLLMs.hitl import ReviewItem, ReviewStatus
            >>> item = ReviewItem(
...
class Priority(int, Enum):
    ...
    Examples:
        Setting priority on review items:
            >>> from insideLLMs.hitl import ReviewItem, Priority
...
class Feedback:
    ...
    Examples:
        Creating approval feedback:
            >>> from insideLLMs.hitl import Feedback, FeedbackType
            >>> feedback = Feedback(
            ...     feedback_type=FeedbackType.APPROVE,
...
class Annotation:
    ...
    Examples:
        Document-level annotation (sentiment labeling):
            >>> from insideLLMs.hitl import Annotation
...
class ReviewItem:
    ...
    Examples:
        Creating a review item:
            >>> from insideLLMs.hitl import ReviewItem, Priority, ReviewStatus
            >>> item = ReviewItem(
        ...
        Adding feedback to an item:
            >>> from insideLLMs.hitl import ReviewItem, Feedback, FeedbackType
            >>> item = ReviewItem(prompt="test", response="result")
        ...
        Adding annotations:
            >>> from insideLLMs.hitl import ReviewItem, Annotation
            >>> item = ReviewItem(
...
class HITLConfig:
    ...
    Examples:
        Default configuration:
            >>> from insideLLMs.hitl import HITLConfig
            >>> config = HITLConfig()
...
class ReviewQueue:
    ...
    Examples:
        Basic queue operations:
            >>> from insideLLMs.hitl import ReviewQueue, ReviewItem
            >>> queue = ReviewQueue()
...
class ConsoleInputHandler:
    ...
    Examples:
        ...
        Using with HITLSession:
            >>> from insideLLMs.hitl import HITLSession, ConsoleInputHandler
            >>> handler = ConsoleInputHandler()
            >>> session = HITLSession(model, input_handler=handler)
...
class ReviewWorkflow:
    ...
    Examples:
        Basic batch review workflow:
            >>> from insideLLMs.hitl import ReviewWorkflow, Priority
        ...
        Priority-based review:
            >>> from insideLLMs.hitl import ReviewWorkflow, PriorityReviewQueue, Priority
            >>> queue = PriorityReviewQueue()
...
class AnnotationWorkflow:
    ...
    Examples:
        Sentiment annotation:
            >>> from insideLLMs.hitl import AnnotationWorkflow
