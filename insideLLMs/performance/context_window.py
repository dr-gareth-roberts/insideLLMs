...
>>> from insideLLMs.performance.context_window import ContextWindow, ContentType, PriorityLevel
...
>>> from insideLLMs.performance.context_window import ConversationManager
...
>>> from insideLLMs.performance.context_window import SlidingWindowManager
...
>>> from insideLLMs.performance.context_window import create_budget
...
class TruncationStrategy(Enum):
    ...
    >>> from insideLLMs.performance.context_window import (
...
class ContentType(Enum):
    ...
    >>> from insideLLMs.performance.context_window import ContextBlock, ContentType, PriorityLevel
...
class PriorityLevel(Enum):
    ...
    >>> from insideLLMs.performance.context_window import ContextWindow, TruncationStrategy
...
class ContentAllocationBudget:
    ...
    >>> from insideLLMs.performance.context_window import ContentAllocationBudget
    ...
    >>> from insideLLMs.performance.context_window import ContentType
    >>> budget = ContentAllocationBudget(total=32000)
...
class TruncationResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.performance.context_window import TruncationResult, TruncationStrategy
...
class ContextCompressionResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.performance.context_window import ContextCompressionResult, CompressionMethod
...
class ContextWindowState:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Examples
        --------
        >>> from insideLLMs.performance.context_window import ContextWindowState, ContentAllocationBudget
...
def estimate_tokens(text: str) -> int:
    ...
    >>> from insideLLMs.performance.context_window import estimate_tokens
...
def find_semantic_boundaries(text: str) -> list[int]:
    ...
    >>> from insideLLMs.performance.context_window import find_semantic_boundaries
...
class TokenCounter:
    ...
    >>> from insideLLMs.performance.context_window import TokenCounter
...
class ContextWindow:
    ...
    >>> from insideLLMs.performance.context_window import TruncationStrategy
    >>> window = ContextWindow(max_tokens=1000)
    >>> for i in range(10):
    ...
    >>> from insideLLMs.performance.context_window import CompressionMethod
    >>> window = ContextWindow(max_tokens=1000)
