...
Example - Cost-Optimized Routing:
    >>> from insideLLMs.routing import SemanticRouter, Route, RouterConfig, RoutingStrategy
    >>> from insideLLMs import DummyModel
    >>>
...
Example - Load Balanced Model Pool:
    >>> from insideLLMs.routing import ModelPool, RoutingStrategy
    >>> from insideLLMs import DummyModel
    >>>
...
Example - Intent-Based Routing:
    >>> from insideLLMs.routing import IntentClassifier, create_intent_router
    >>> from insideLLMs import DummyModel
    >>>
...
class RoutingStrategy(Enum):
    ...
    Example - Using BEST_MATCH strategy:
        >>> from insideLLMs.routing import RouterConfig, RoutingStrategy
...
class RouteStatus(Enum):
    ...
    Example - Checking route status:
        >>> from insideLLMs.routing import Route, RouteStatus
        >>> from insideLLMs import DummyModel
...
class RouterConfig:
    ...
    Example - Default configuration:
        >>> from insideLLMs.routing import RouterConfig
        >>> config = RouterConfig()
...
class RouteMatch:
    ...
    Example - Converting to dictionary for logging:
        >>> from insideLLMs.routing import RouteMatch
        >>> from insideLLMs import DummyModel
        >>> match = RouteMatch(
        ...     route_name="test",
        ...     score=0.85,
...
class RoutingResult:
    ...
    Example - Monitoring retries:
        >>> from insideLLMs.routing import SemanticRouter, Route, RouterConfig
        >>> from insideLLMs import DummyModel
    ...
    Example - Error handling:
        >>> from insideLLMs.routing import SemanticRouter
        >>> router = SemanticRouter()
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Example:
            >>> from insideLLMs.routing import RoutingResult
...
class RouteStats:
    ...
    Example - Monitoring error rates:
        >>> from insideLLMs.routing import Route, RouteStats
        >>> from insideLLMs import DummyModel
    ...
    Example - Converting to dictionary for reporting:
        >>> from insideLLMs.routing import RouteStats
...
class Route:
    ...
    Example - Creating a simple route:
        >>> from insideLLMs.routing import Route
        >>> from insideLLMs import DummyModel
        >>> route = Route(
        ...     name="greeting",
...
class SemanticMatcher:
    ...
    Example - Using with embeddings:
        >>> from insideLLMs.routing import SemanticMatcher
...
class SemanticRouter:
    ...
    def select_route(self, matches: list[RouteMatch]) -> Optional[RouteMatch]:
        ...
        Example - Best match selection:
            >>> from insideLLMs.routing import SemanticRouter, Route, RouteMatch
            >>> from insideLLMs import DummyModel
        ...
        Example - Round robin selection:
            >>> from insideLLMs.routing import SemanticRouter, Route, RouterConfig, RoutingStrategy, RouteMatch
            >>> from insideLLMs import DummyModel
            >>> config = RouterConfig(strategy=RoutingStrategy.ROUND_ROBIN)
            >>> router = SemanticRouter(config=config)
            >>> matches = [
...
class ModelPool:
    ...
    Example - Basic round-robin pool:
        >>> from insideLLMs.routing import ModelPool
        >>> from insideLLMs import DummyModel
    ...
    Example - Using pool as a route model:
        >>> from insideLLMs.routing import ModelPool, SemanticRouter, Route
        >>> from insideLLMs import DummyModel
...
class IntentClassifier:
    ...
    Example - Pattern-based classification:
        >>> from insideLLMs.routing import IntentClassifier
        >>> classifier = IntentClassifier()
    ...
    Example - Using with router:
        >>> from insideLLMs.routing import IntentClassifier, SemanticRouter, Route
        >>> from insideLLMs import DummyModel
        >>> # Create classifier
        >>> classifier = IntentClassifier()
...
def create_router(
    ...
    Example - Basic router creation:
        >>> from insideLLMs.routing import create_router
        >>> from insideLLMs import DummyModel
...
def quick_route(
    ...
    Example - Simple quick routing:
        >>> from insideLLMs.routing import quick_route
        >>> from insideLLMs import DummyModel
        >>> result = quick_route(
...
def create_intent_router(
    ...
    Example - Basic intent router:
        >>> from insideLLMs.routing import create_intent_router
        >>> from insideLLMs import DummyModel
