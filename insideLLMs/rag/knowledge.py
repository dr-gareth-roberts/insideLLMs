...
Example: Basic Claim Extraction and Verification
    >>> from insideLLMs.rag.knowledge import extract_claims, verify_claim
...
Example: Knowledge Probing with a Model
    >>> from insideLLMs.rag.knowledge import probe_knowledge
...
Example: Consistency Testing
    >>> from insideLLMs.rag.knowledge import check_consistency
...
Example: Full Fact Verification Pipeline
    >>> from insideLLMs.rag.knowledge import verify_facts
...
class VerificationStatus(Enum):
    ...
    Example: Checking Verification Status
        >>> from insideLLMs.rag.knowledge import verify_claim, Claim, VerificationStatus
...
class KnowledgeCategory(Enum):
    ...
    Example: Categorizing Knowledge Probes
        >>> from insideLLMs.rag.knowledge import KnowledgeProbe, KnowledgeCategory
    ...
    Example: Analyzing Results by Category
        >>> from insideLLMs.rag.knowledge import KnowledgeProber
    ...
    Example: Filtering Claims by Category
        >>> from insideLLMs.rag.knowledge import extract_claims
...
class ConfidenceLevel(Enum):
    ...
    Example: Mapping Numeric Confidence to Levels
        >>> from insideLLMs.rag.knowledge import ConfidenceLevel
...
class Claim:
    ...
    Example: Creating a Simple Claim
        >>> from insideLLMs.rag.knowledge import Claim, KnowledgeCategory
        >>> claim = Claim(
...
class VerificationResult:
    ...
    Example: Basic Verification
        >>> from insideLLMs.rag.knowledge import verify_claim, Claim
...
class ClaimExtractor:
    ...
    Example: Basic Claim Extraction
        >>> from insideLLMs.rag.knowledge import ClaimExtractor
...
class FactVerifier:
    ...
    Example: Basic Fact Verification
        >>> from insideLLMs.rag.knowledge import FactVerifier, Claim
        >>> kb = {
    ...
    Example: Using the Convenience Function
        >>> from insideLLMs.rag.knowledge import verify_claim
        >>> result = verify_claim(
...
class KnowledgeProber:
    ...
    Example: Basic Knowledge Probing
        >>> from insideLLMs.rag.knowledge import KnowledgeProber, KnowledgeCategory
        >>> prober = KnowledgeProber()
        >>> prober.add_probe(
        ...     question="What is the capital of France?",
        ...     expected_answer="Paris",
...
class ConsistencyTester:
    ...
    Example: Basic Consistency Testing
        >>> from insideLLMs.rag.knowledge import ConsistencyTester
...
class SourceAttributor:
    ...
    Example: Basic Source Attribution
        >>> from insideLLMs.rag.knowledge import SourceAttributor, Claim
