...
>>> from insideLLMs.parsing import parse_json
>>> response = '''
...
>>> from insideLLMs.parsing import parse_code
>>> response = '''
...
>>> from insideLLMs.parsing import parse_list
>>> response = '''
...
>>> from insideLLMs.parsing import extract_answer
...
class OutputFormat(Enum):
    ...
    >>> from insideLLMs.parsing import detect_format, OutputFormat
    >>> text = '{"key": "value"}'
...
class CodeBlock:
    ...
    >>> from insideLLMs.parsing import CodeBlockParser
    >>> response = '''
    ... ```javascript
    ... console.log("Hello");
    ... ```
...
class TableData:
    ...
    >>> from insideLLMs.parsing import parse_table
    >>> response = '''
    ... | Language   | Year |
    ... |------------|------|
    ... | Python     | 1991 |
...
class JSONParser:
    ...
    >>> from insideLLMs.parsing import JSONParser
...
class ListParser:
    ...
    >>> from insideLLMs.parsing import ListParser
    >>> text = '''
    ... 1. First item
    ... 2. Second item
    ... 3. Third item
...
class TableParser:
    ...
    >>> from insideLLMs.parsing import TableParser
    >>> text = '''
    ... | Name    | Age |
    ... |---------|-----|
    ... | Alice   | 30  |
...
class AnswerExtractor:
    ...
    >>> from insideLLMs.parsing import AnswerExtractor
...
class OutputDetector:
    ...
    >>> from insideLLMs.parsing import OutputDetector, OutputFormat
